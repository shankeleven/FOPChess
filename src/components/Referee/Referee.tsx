        ...
        {/* <h3 style={{ fontSize: "62px", textAlign: "center" }} id="logo"> FOP Chess </h3> */}
            ...
            <div className="modal hidden" ref={modalRef}>
                <div className="modal-body">
                    ...
                    <img onClick={() => promotePawn(PieceType.BISHOP)} src={`/assets/images/bishop_${promotionTeamType()}.svg`} />
                    <img onClick={() => promotePawn(PieceType.KNIGHT)} src={`/assets/images/knight_${promotionTeamType()}.svg`} />
                    <img onClick={() => promotePawn(PieceType.QUEEN)} src={`/assets/images/queen_${promotionTeamType()}.svg`} />
                </div>
            </div>
